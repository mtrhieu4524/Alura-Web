...
//             <h4>Customers</h4>
//             <p className="value">{summary.customers}</p>
...
//           <div className="dashboard_card">
//             <h4>Orders</h4>
//             <p className="value">{summary.orders}</p>
...
//           <div className="dashboard_card">
//             <h4>Earnings</h4>
//             <p className="value">{(summary.earnings.toLocaleString())} VND</p>
//             <p className={percentChange.earnings >= 0 ? "positive" : "negative"}>
//               {percentChange.earnings >= 0 ? "▲" : "▼"} {Math.abs(percentChange.earnings)}% Since last month
//             </p>
//           </div>
//           <div className="dashboard_card">
//             <h4>Growth</h4>
//             <p className="value">+ {summary.growth}%</p>
//             <p className={percentChange.growth >= 0 ? "positive" : "negative"}>
//               {percentChange.growth >= 0 ? "▲" : "▼"} {Math.abs(percentChange.growth)}% Since last month
//             </p>
//           </div>
//         </div>
...
//             </thead>
//             <tbody>
//               <tr><td>Pocket Drone 2.4G VND</td><td>129.99 VND</td><td>32</td><td>6089.58 VND</td></tr>
//               <tr><td>Marco Lightweight Shirt VND</td><td>55.99 VND</td><td>47</td><td>3689.73 VND</td></tr>
//               <tr><td>Lightweight Jacket VND</td><td>73.99 VND</td><td>53</td><td>1689.57 VND</td></tr>
//               <tr><td>DJI Phantom 4 PRO VND</td><td>499.99 VND</td><td>25</td><td>8489.05 VND</td></tr>
//               <tr><td>ST SwellPro Drone VND</td><td>219.99 VND</td><td>12</td><td>2689.58 VND</td></tr>
//             </tbody>
//           </table>
//         </div>
//       </div>
    ...
    <div className="Dashboard">
      <div className="dashboard_container">
        ...
        <div className="dashboard_cards">
          ...
          <div className="dashboard_card">
            <h4>Earnings</h4>
            <p className="value">{(summary.earnings || 0).toLocaleString()} VND</p>
            <p className={percentChange.earnings >= 0 ? "positive" : "negative"}>
              {percentChange.earnings >= 0 ? "▲" : "▼"} {Math.abs(percentChange.earnings)}% Since last month
            </p>
          </div>
          <div className="dashboard_card">
            <h4>Growth</h4>
            <p className="value">+ {summary.growth || 0}%</p>
            <p className={percentChange.growth >= 0 ? "positive" : "negative"}>
              {percentChange.growth >= 0 ? "▲" : "▼"} {Math.abs(percentChange.growth)}% Since last month
            </p>
          </div>
