...
function OrderDetail() {
    ...
    const handleProductView = (product) => {
        navigate(`/cosmetics/${product.productId}`, { state: { id: product.productId } });
    };
                        ...
                        {loading ? (
                            ...
                            <>
                                        ...
                                        <div className="order_detail_product_info">
                                            <div className="order_detail_product_header">
                                                ...
                                                <div className="order_detail_product_links">
                                                    <a href="#" onClick={(e) => { e.preventDefault(); handleProductView(product); }}>VIEW</a>
                                                </div>
                                            </div>
                                ...
                                <div className="order_detail_customer_info">
                                    <div className="order_detail_customer_row">
                                        <div className="order_detail_customer_item">
                                            ...
                                            <span><strong>Customer Name: </strong>{orderDetails?.name}</span>
                                        </div>
                                        <div className="order_detail_customer_item">
                                            <i className="fas fa-phone"></i>
                                            <span><strong>Phone Number: </strong>{orderDetails?.phoneNumber}</span>
                                        </div>
                                    </div>
                                    <div className="order_detail_customer_row">
                                        <div className="order_detail_customer_item">
                                            <i className="fas fa-credit-card"></i>
                                            <span><strong>Payment Method: </strong>{orderDetails?.paymentMethod}</span>
                                        </div>
                                        <div className="order_detail_customer_item">
                                    ...
                                    <div className="order_detail_customer_row">
                                        <div className="order_detail_customer_item">
                                            ...
                                            <span><strong>Address: </strong>{orderDetails?.shippingAddress}</span>
                                        </div>
                                        <div className="order_detail_customer_item">
                                            <i className="fas fa-sticky-note"></i>
                                            <span><strong>Note: </strong>{orderDetails?.note}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="order_detail_actions">
                                    <button className="order_detail_continue_shopping" onClick={() => navigate('/cosmetics')}>
                                        <i className="fas fa-shopping-cart"></i> Continue shopping
                                    </button>
                                    <button className="order_detail_contact_us" onClick={() => navigate('/contact')}>
