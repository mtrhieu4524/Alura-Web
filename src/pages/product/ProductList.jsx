      ...
      <div className="filters_and_products">
        <div className="filters_products">
          ...
          <FormControl className="filter_group_sort" size="small">
            ...
            <Select
              ...
              <MenuItem value="Price (Low to High)">
                Price{" "}
                <i className="fas fa-arrow-up" style={{ marginLeft: 8 }}></i>
              </MenuItem>
              <MenuItem value="Price (High to Low)">
                Price{" "}
                <i className="fas fa-arrow-down" style={{ marginLeft: 8 }}></i>
              </MenuItem>
            </Select>
          </FormControl>
          ...
          <FormControl className="filter_group" size="small">
            ...
            <Select labelId="brandFilter-label" id="brandFilter" label="Brand">
              <MenuItem value="">None</MenuItem>
