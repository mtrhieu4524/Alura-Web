    ...
    return (
        <div id="product_detail" className="product_detail">
            ...
            <div className="product_detail_container">
                ...
                <div className="product_info_detail">
                        ...
                        <div className="quantity_selector_container">
                            <div className="quantity_controls">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        const value = Math.max(
                                            1,
                                            Math.min(maxProductAvailable, parseInt(e.target.value) || 1)
                                        );
                                        setQuantity(value);
                                    }}
                                />
                                <button
                                    className="quantity_btn"
                                    onClick={() =>
                                        setQuantity((prev) => Math.min(prev + 1, maxProductAvailable))
                                    }
                    ...
                    <div className="product_delivery_detail">
                        ...
                        <p>
                            <i className="fas fa-calendar-alt"></i> Estimated delivery in 3–5 days
                        </p>
                    </div>
                    <hr className="product_detail_line" />
                </div>
            ...
            <p className="GIA_content">
                Alurà guarantees the authenticity and safety of all products—trusted by
